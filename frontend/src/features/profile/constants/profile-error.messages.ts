...
export const UPDATE_PROFILE_IMAGE_ERROR_MESSAGES: Record<string, string> = {
  PROFILE_NOT_FOUND: 'We couldn’t find your profile. Please try again later.',
  DEFAULT:
    'Something went wrong while updating your profile photo. Please try again.',
} as const;

export const UPDATE_COVER_IMAGE_ERROR_MESSAGES: Record<string, string> = {
  PROFILE_NOT_FOUND: 'We couldn’t find your profile. Please try again later.',
  DEFAULT:
    'Something went wrong while updating your cover photo. Please try again.',
} as const;
