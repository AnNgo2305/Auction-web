...
import type { DeleteProductsResponse } from '@/features/seller-hub/types/product/delete-products.response';
import type { ApiResponseError } from '@/shared/types/error';

export function useDeleteProducts() {
  const queryClient = useQueryClient();

  return useMutation<DeleteProductsResponse, ApiResponseError, string[]>({
    mutationFn: async (
      productIds: string[],
